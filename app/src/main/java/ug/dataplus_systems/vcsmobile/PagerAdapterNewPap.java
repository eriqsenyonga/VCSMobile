...
public class PagerAdapterNewPap extends FragmentStatePagerAdapter {
    ...
    public static int NEW_PAP_STEP_PROPERTY_INFO_CROPS = 2;
    public static int NEW_PAP_STEP_PROPERTY_INFO_IMPROVEMENTS = 3;
    public static int NEW_PAP_STEP_OTHER_DETAILS = 4;
    public static int NEW_PAP_STEP_PAP_PHOTOS= 5;
    public static int NEW_PAP_STEP_PREVIEW = 6;
